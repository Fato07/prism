...
**Fail-closed example:** [Canonical fail-closed report](https://raw.githubusercontent.com/Fato07/prism/refs/heads/main/docs/protocol/fixtures/fail-closed-report.json) — capital gate BLOCK with unresolved blocking issues. Also see the [Security model](/docs/security).

**Protocol reference:** The full [Prism Protocol v0 specification](https://raw.githubusercontent.com/Fato07/prism/refs/heads/main/docs/protocol/prism-protocol-v0.md) defines the `prism.report.v0` interchange format. The [JSON Schema](https://raw.githubusercontent.com/Fato07/prism/refs/heads/main/docs/protocol/prism-report-v0.schema.json) (Draft 2020-12) is the machine-readable definition.
