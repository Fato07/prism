...
Reuses the same pattern as the trader's PinataClient but lives in
the sentinel package for service independence.
"""
...
logger = structlog.get_logger("prism.sentinel.ipfs")
